...
import com.vodafone.financialtool.beans.ConfigurationsFacade;
...
public class ConfigurationsController implements Serializable {
    ...
    @EJB
    private com.vodafone.financialtool.beans.ConfigurationsFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setConfigurationsPK(new com.vodafone.financialtool.entities.ConfigurationsPK());
    }
    ...
    public Configurations getConfigurations(com.vodafone.financialtool.entities.ConfigurationsPK id) {
    ...
    public static class ConfigurationsControllerConverter implements Converter {
        ...
        com.vodafone.financialtool.entities.ConfigurationsPK getKey(String value) {
            com.vodafone.financialtool.entities.ConfigurationsPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.vodafone.financialtool.entities.ConfigurationsPK();
            key.setConfName(values[0]);
            key.setConfEnviroment(values[1]);
            return key;
        }

        String getStringKey(com.vodafone.financialtool.entities.ConfigurationsPK value) {
